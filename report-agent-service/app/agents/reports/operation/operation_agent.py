"""operation(운영) 보고서 에이전트 — 팀원 구현 예정.

계약: operation_agent(state) -> {"draft": str, "narrative": str | None}
...
def operation_agent(state) -> dict:
    raise NotImplementedError(
        "operation_agent 구현 예정: tool_outputs로 분석 생성 후 builder.render_report 조립"
    )
