...
/**
 * 월별 발전량 집계(cron 롤업, RDS 직접 조회). 복합 PK (turbine_id, stat_at). stat_at(time)은 해당 월 1일 00:00.
...
public class MonthlyGeneration {
    ...
    /** 월별 누적 발전량 (kWh) */
    @Column(name = "monthly_power_output")
    private Double monthlyPowerOutput;
}
